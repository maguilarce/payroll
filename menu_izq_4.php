            ...
            <ul class="nav nav-stacked">                
                <li class="nav-header"> <a href="#" data-toggle="collapse" data-target="#menu1"><strong>Options</strong> <i class="glyphicon glyphicon-user"></i></a>
                    <ul class="nav nav-stacked collapse in" id="menu1">
                           <li class="active"> <a href="create_weekly_timesheet_superintendent1.php" target="mainFrame">Weekly Timesheets</a></li>
                           ...
                           <li class="active"> <a href="project_table.php" target="mainFrame">View/Edit <br> Current Projects</a></li>

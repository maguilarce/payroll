                    ...
                    <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "{$row['status_type']} <br>"; ?></td>
                                    <td>
                         ...
                         <div class="panel-body">
                             <form action="add_status_form.php" class="form form-vertical" method="post">
                                <div class="control-group">
                                    <label>New status name:</label>
                                    <div class="controls">
                                        <input name="new_status" type="text" class="form-control" placeholder="Enter new status">

                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="project" value="<?php echo $project_name; ?>">
                                            ...
                                            <button type="submit" formaction="edit_daily_data_form.php" class="btn btn-primary">Modify</button>
                                        
                                        
                                        <button onclick="eliminar();" type="submit" formaction="delete_daily_data_form.php" class="btn btn-primary">Delete</button><br/><br/>

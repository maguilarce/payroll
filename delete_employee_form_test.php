                        ...
                        <div class="panel-body">
                            <form action="edit_employee.php" method="post" class="form form-vertical">
                                <div class="control-group">
                                    <label>Name</label>
                                    <div class="controls">
                                        <input name="name" type="text" value="<?php echo "{$row['name']}"; ?>" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label>License Number</label>
                                    <div class="controls">
                                        <input name="license_number" type="text" value="<?php echo "{$row['license_number']}"; ?>" class="form-control" disabled>
                                    </div>
                                 </div>   
                                 <div class="control-group">
                                    <label>SSN</label>
                                    <div class="controls">
                                        <input name="social_security_number" type="text" value="<?php echo "{$row['social_security_number']}"; ?>" class="form-control" disabled>
                                    </div>
                                </div>
                                 <div class="control-group">
                                    <label>Address</label>
                                    <div class="controls">
                                        <input name="address" type="text" value="<?php echo "{$row['address']}"; ?>" class="form-control" disabled>
                                    </div>
                                </div> 
                                <div class="control-group">
                                    <label>Phone Number</label>
                                    <div class="controls">
                                        <input name="phone_number" type="text" value="<?php echo "{$row['phone_number']}"; ?>" class="form-control" disabled>
                                    </div>
                                </div> 
                                <div class="control-group">
                                    <label>Email</label>
                                    <div class="controls">
                                        <input name="email" type="text" value="<?php echo "{$row['email']}"; ?>" class="form-control" disabled>
                                    </div>
                                </div>                                  
                                <div class="control-group">
                                    <label>Union Trade</label>
                                    <div class="controls">
                                        <input value="<?php echo "{$row['union_trade']}"; ?>" name="union_trade" class="form-control" disabled> 
